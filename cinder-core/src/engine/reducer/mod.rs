...
use self::handlers::{
    ...
    handle_actor_spoke, handle_actor_spoke_to_room, handle_channel_message,
    handle_current_room_observed, handle_feature_observed, handle_help_shown, handle_hostile_strike, handle_item_acquired,
...
pub fn apply_events(
    ...
    while let Some(entry) = pending.pop_front() {
        match &entry.event {
            ...
            WorldEvent::ChannelMessage { message } => {
                handle_channel_message(state, content, &mut lines, message);
            }

...
use super::builder::{ActorTurnRealizationContext, ActorTurnTargetContext};
use super::context::{
...
use super::realization::realize_actor_turn_action;
...
pub fn run_actor_turn(
    ...
    let action = decide_actor_turn_action(content.as_ref(), &request, emit_trace)?;
    realize_actor_turn_action(
        content.as_ref(),
        dialogue.as_ref(),
        state,
        actor,
